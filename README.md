...
[![Pydantic](https://img.shields.io/badge/Pydantic-2.12+-E92063.svg)](https://docs.pydantic.dev/)
...
- [Структура репозитория](#-структура-репозитория-основное)
- [Архитектура и поток данных](#-архитектура-и-поток-данных)
- [API](#-api)
- [Модели данных](#-модели-данных-pydantic)
- [Конфигурация и окружения](#-конфигурация-и-окружения)
- [Запуск в Docker](#-запуск-в-docker-рекомендуется)
- [Локальный запуск](#-локальный-запуск-без-docker-опционально)
- [Примеры запросов](#-примеры-запросов-curl)
- [Технические детали](#-технические-детали)
- [Дорожная карта](#-дорожная-карта--улучшения)
- [Лицензия](#-лицензия)

## 🛠 Технологический стек

- **Язык/Runtime:** Python 3.12+
- **Веб-фреймворк:** FastAPI 0.121.0 + Starlette 0.49.3
- **Валидация:** Pydantic v2.12.4 (+ pydantic-extra-types для телефонов)
- **Хранилище:** Redis 7.0+ (через redis.asyncio)
- **Конфигурация:** pydantic-settings (переменные окружения, .env)
- **ASGI-сервер:** Uvicorn 0.38.0 (dev), Gunicorn 23.0.0 (prod)
